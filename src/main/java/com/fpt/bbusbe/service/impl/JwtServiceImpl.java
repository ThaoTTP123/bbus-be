...
public class JwtServiceImpl implements JwtService {
    ...
    @Override
    public String generateAccessToken(String phone, UUID userId, List<String> authorities) {
    ...
    @Override
    public String generateRefreshToken(String phone, UUID userId, List<String> authorities) {
    ...
    private String generateToken(Map<String, Object> claims, String phone, UUID userId) {
    ...
    private String generateRefreshToken(Map<String, Object> claims, String phone, UUID userId) {
